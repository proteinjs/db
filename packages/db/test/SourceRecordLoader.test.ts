 ...
 */
describe("SourceRecordLoader.resolveSourceVersion — the booting package's own version", () => {
  ...
  const resolveSourceVersion = (source: string) =>
    (new SourceRecordLoader() as unknown as VersionInternals).resolveSourceVersion(source);
